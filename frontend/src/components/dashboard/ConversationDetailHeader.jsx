...
function lastSeenText(receiver) {
  if (!receiver) return "";
  ...
  return `Last seen ${new Date(receiver.lastSeen).toLocaleDateString(undefined, {
    month: "short",
    day: "numeric",
  })}`;
}
      ...
      <Dialog open={profileOpen} onOpenChange={setProfileOpen}>
        <DialogContent className="sm:max-w-sm">
          ...
          <div className="space-y-3 text-sm">
            ...
            {receiver?.about && (
              <div>
                <p className="text-xs text-muted-foreground uppercase">About</p>
