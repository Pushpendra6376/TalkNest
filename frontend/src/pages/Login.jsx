                ...
                <div className="w-full max-w-md flex flex-col gap-6">
                    ...
                    <Card className="rounded-2xl border border-border/60 bg-card/50 backdrop-blur-xs shadow-xl shadow-black/5 dark:shadow-black/25 p-8 w-full">
                        ...
                        <Tabs defaultValue="password" className="w-full">
                            <TabsList className="w-full grid grid-cols-2 mb-6 bg-muted/40">
                                <TabsTrigger value="password" className="text-sm font-medium">
                                    Password
                                </TabsTrigger>

                                <TabsTrigger value="otp" className="text-sm font-medium">
                                    OTP Login
                                </TabsTrigger>
                            </TabsList>
                                ...
                                <div className="space-y-5">
                                    ...
                                    {!otpSent ? (
                                        ...
                                        >
                                            ...
                                            <p className="text-sm text-muted-foreground bg-muted/40 rounded-lg p-3 border border-border/40">
                                        ...
                                        >
                                                ...
                                                <div className="flex justify-center pt-2 pb-2">
                                                    ...
                                                    >
                                                        <InputOTPGroup>
                                                            ...
                                                            <InputOTPSlot index={1} className="h-11 w-11 rounded-lg" />
                                                            <InputOTPSlot index={2} className="h-11 w-11 rounded-lg" />
                                                            <InputOTPSlot index={3} className="h-11 w-11 rounded-lg" />
                                                            <InputOTPSlot index={4} className="h-11 w-11 rounded-lg" />
                                                            <InputOTPSlot index={5} className="h-11 w-11 rounded-lg" />
                                                        </InputOTPGroup>
                                                    </InputOTP>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-center justify-between text-xs gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-1 text-muted-foreground hover:text-primary disabled:opacity-40 transition-colors"
                                                >
