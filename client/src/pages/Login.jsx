                ...
                <div className="bg-[#1e293b]/95 p-8 md:p-10 rounded-3xl border border-white/10">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-400 mt-2">
                            Enter your credentials to access TalkNest
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                required
                                className="w-full pl-12 pr-12 py-3.5 bg-slate-800/50 border border-slate-700 rounded-2xl text-white"
                            />
                            <button
                                type="button"
                        ...
                        <div className="flex justify-end">
                            <Link to="/forgot-password" className="text-xs text-teal-400">
                                Forgot Password?
                            </Link>
                        </div>
                        ...
                        <button
                            disabled={loading}
                            className="w-full py-4 bg-gradient-to-r from-teal-500 to-purple-600 text-white font-bold rounded-2xl disabled:opacity-50"
                        >
                    ...
                    <p className="mt-8 text-center text-slate-400 text-sm">
                        ...
                        <Link to="/register" className="text-teal-400 font-bold ml-1">
                            Register Now
                        </Link>
                    </p>
